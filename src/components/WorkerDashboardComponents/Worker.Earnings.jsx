...
const WorkerEarnings = () => {
  return (
    <div className="p-6 bg-white rounded-xl shadow-md border border-gray-100 text-gray-800">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        {/* Total Earnings */}
        <div className=" bg-gradient-to-l from-[#5A9690] to-[#2F5755] rounded-xl p-5 shadow-sm flex items-center gap-4 hover:shadow-md transition">
          <Wallet size={32} className="text-white" />
          <div>
            <p className="text-2xl text-yellow-400 font-semibold">$450</p>
        ...
        <div className="bg-gradient-to-l from-[#5A9690] to-[#2F5755] rounded-xl p-5 shadow-sm flex items-center gap-4 hover:shadow-md transition">
          ...
          <div>
            <p className="text-2xl text-yellow-400 font-semibold">$120</p>
            <p className="text-white text-sm">Withdrawable</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-l from-[#5A9690] to-[#2F5755] rounded-xl p-5 shadow-sm flex items-center gap-4 hover:shadow-md transition">
          ...
          <div>
            <p className="text-2xl text-yellow-400 font-semibold">$80</p>
            <p className="text-white text-sm">Pending Payments</p>
          </div>
        </div>
      </div>
